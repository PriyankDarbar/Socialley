                            ...
                            <div className="container">
                                <ul className="nav nav-tabs" id="myTab" role="tablist">
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link " id="posts-tab" data-bs-toggle="tab" data-bs-target="#posts" type="button" role="tab" aria-controls="posts" aria-selected="false">Posts</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link active" id="events-tab" data-bs-toggle="tab" data-bs-target="#events" type="button" role="tab" aria-controls="events" aria-selected="true">Events</button>
                                    </li>
                                    <li className="nav-item" role="presentation">
                        ...
                        <div className="sl-yoga-tab-content">
                            <div className="container">
                                <div className="tab-content" id="myTabContent">
                                    <div className="tab-pane fade" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                        <div className="sl-yoga-tab-content__inner">
                                            <div className="sl-yoga-events-content sl-user-profile-myEvents-content">
                                                <Link to="/create-post-inside-community" className=" btn btn-success">Create new Post</Link>
                                    ...
                                    <div className="tab-pane fade active show" id="events" role="tabpanel" aria-labelledby="events-tab">
                                        <div className="sl-yoga-tab-content__inner">
                                            <div className="sl-yoga-events-content sl-user-profile-myEvents-content">
                                                <Link to="/create-event-inside-community" className="btn btn-success">Create new event</Link>
