    ...
    return (
        <Fragment>
            ...
            <div className="sl-site-content">
                <section className="sl-landing-section sl-single-community-landing sl-admin-community-landing" style={{ backgroundImage: "url(images/community-img.png)" }}>
                    ...
                    <div className="sl-landing-btn">
                        <div className="container">
                            <a href="#" className="btn btn-primary">Edit  Cover</a>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col col-12 col-md-6 col-lg-6">
                                <div className="sl-community-event-content">
                                    <div className="sl-community-event-header">
                                        ...
                                        <Link to="/create-event-inside-community">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="text-center">
                                            <Link to="/yoga-events" className="sl-section-link" >View all events</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="container">
                        <div className="sl-community-event-content">
                            <div className="row">
                                <div className="col col-12 col-md-12 col-lg-6 ">
                                    <div className="sl-community-event-header">
                                        ...
                                        <Link to="/create-post-inside-community">
                                            <img src="images/add-icon.png" alt="add-icon" className="img-fluid" />
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className="row">
                                ...
                                <div className="text-center">
                                    <div className="sl-section-link" onClick={handleAdmin} style={{ cursor: "pointer" }} >View all posts</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="modal-body">
                                ...
                                <div className="sl-all-members-content" data-scrollbar="true" tabindex="-1" style={{ overflow: "hidden", outline: "none" }}>
                                    ...
                                    <div className="scrollbar-track scrollbar-track-y" style={{ display: "none" }}>
                                        <div className="scrollbar-thumb scrollbar-thumb-y"></div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
...
export default Community_Admin_Open;